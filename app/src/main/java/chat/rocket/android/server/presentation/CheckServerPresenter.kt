...
import chat.dk.android.helper.OauthHelper
...
import chat.dk.android.server.domain.casLoginUrl
import chat.dk.android.server.domain.gitlabUrl
import chat.dk.android.server.domain.isCasAuthenticationEnabled
import chat.dk.android.server.domain.isFacebookAuthenticationEnabled
import chat.dk.android.server.domain.isGithubAuthenticationEnabled
import chat.dk.android.server.domain.isGitlabAuthenticationEnabled
import chat.dk.android.server.domain.isGoogleAuthenticationEnabled
import chat.dk.android.server.domain.isLinkedinAuthenticationEnabled
import chat.dk.android.server.domain.isLoginFormEnabled
import chat.dk.android.server.domain.isRegistrationEnabledForNewUsers
import chat.dk.android.server.domain.isWordpressAuthenticationEnabled
import chat.dk.android.server.domain.wordpressUrl
import chat.dk.android.server.domain.GetCurrentServerInteractor
import chat.dk.android.server.domain.RemoveAccountInteractor
...
import chat.dk.android.util.VersionInfo
import chat.dk.android.util.extension.launchUI
import chat.dk.android.util.extensions.casUrl
import chat.dk.android.util.extensions.generateRandomString
import chat.dk.android.util.extensions.parseColor
import chat.dk.android.util.extensions.samlUrl
